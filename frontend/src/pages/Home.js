      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Comprehensive AI-powered analytics for your League of Legends performance.
            Discover insights, track progress, and unlock your potential.
          </p>

          <div className="search-wrapper">
            <div className="search-box">
              <SearchForm onSearch={handleSearch} loading={loading} />
              <p className="search-hint">Enter your Riot ID (e.g., PlayerName#NA1)</p>
            </div>
        ...
        <>
          <div className="features-section">
            <div className="section-header">
              ...
              <p>Everything you need to understand your gameplay</p>
            </div>
            ...
            <div className="features-grid">
              <div className="feature-item">
                ...
                <p>Track KDA, win rates, damage dealt, and objective participation across all your matches</p>
              </div>
              ...
              <div className="feature-item">
                ...
                <p>Deep dive into your most played champions with detailed statistics and mastery tracking</p>
              </div>
              ...
              <div className="feature-item">
                ...
                <h3>AI Insights</h3>
                <p>Get personalized recommendations and strategic insights powered by Claude AI</p>
              </div>
              ...
              <div className="feature-item">
                ...
                <h3>Visual Data</h3>
                <p>Beautiful interactive charts that make your performance data easy to understand</p>
              </div>
            </div>
          </div>
